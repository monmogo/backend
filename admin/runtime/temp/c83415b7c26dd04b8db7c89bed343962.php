<?php /*a:6:{s:67:"/www/wwwroot/www/admin/application/admin/view/withdrawal/index.html";i:1638604914;s:62:"/www/wwwroot/www/admin/application/admin/view/public/meta.html";i:1638604914;s:63:"/www/wwwroot/www/admin/application/admin/view/public/style.html";i:1638604914;s:62:"/www/wwwroot/www/admin/application/admin/view/public/menu.html";i:1662533153;s:62:"/www/wwwroot/www/admin/application/admin/view/public/head.html";i:1638604914;s:64:"/www/wwwroot/www/admin/application/admin/view/public/footer.html";i:1638604914;}*/ ?>
<!DOCTYPE html>
<html lang="zh">
<head>
<meta charset="utf-8">
      ...
      layer.confirm('确认删除数据？', function(index){
        $.ajax({
          ...
          layer.prompt({title: '请输入描述，并确认', formType: 2}, function(text, index){
            layer.close(index);
            $.post("<?php echo url('acceptWithdrawal'); ?>"+"?id="+data.id,{desc:text,status:2},function(res){
                if(res.code === 200){
                   layer.msg(res.msg, {
                      icon: 1,
          ...
          layer.prompt({title: '请输入描述，并确认', formType: 2}, function(text, index){
            layer.close(index);
            $.post("<?php echo url('acceptWithdrawal'); ?>"+"?id="+data.id,{desc:text,status:3},function(res){
                if(res.code === 200){
                   layer.msg(res.msg, {
                      icon: 1,
                      time: 2000 //2秒关闭（如果不配置，默认是3秒）
