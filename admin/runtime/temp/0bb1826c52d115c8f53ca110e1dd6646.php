<?php /*a:6:{s:66:"/www/wwwroot/www/admin/application/admin/view/yulottery/index.html";i:1638604914;s:62:"/www/wwwroot/www/admin/application/admin/view/public/meta.html";i:1638604914;s:63:"/www/wwwroot/www/admin/application/admin/view/public/style.html";i:1638604914;s:62:"/www/wwwroot/www/admin/application/admin/view/public/menu.html";i:1662533153;s:62:"/www/wwwroot/www/admin/application/admin/view/public/head.html";i:1638604914;s:64:"/www/wwwroot/www/admin/application/admin/view/public/footer.html";i:1638604914;}*/ ?>
<!DOCTYPE html>
<html lang="zh">
<head>
<meta charset="utf-8">
                    ...
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-inline">
                            <select name="key">
                              ...
                              <?php foreach($lottery as $key=>$vo): ?> 
                                  <option value="<?php echo htmlentities($vo['key']); ?>"><?php echo htmlentities($vo['name']); ?></option>
                              <?php endforeach; ?>                                
                            </select>
                        </div>
        ...
        table.on('tool(dataTable)', function (obj) {
            ...
            if (obj.event === 'save') {
                ...
                layer.open({
                    ...
                    content: "<?php echo url('edit_lottery'); ?>"+"?name="+obj.data.name+"&key="+obj.data.key+"&opencode="+obj.data.opencode+"&expect="+obj.data.expect+"&create_time="+obj.data.create_time
                });
            }
        });
