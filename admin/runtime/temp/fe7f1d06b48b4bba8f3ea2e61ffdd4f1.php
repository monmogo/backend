<?php /*a:6:{s:73:"/www/wwwroot/www/admin/application/admin/view/xuanfei/xuanfeiaddress.html";i:1662531438;s:62:"/www/wwwroot/www/admin/application/admin/view/public/meta.html";i:1638604914;s:63:"/www/wwwroot/www/admin/application/admin/view/public/style.html";i:1638604914;s:62:"/www/wwwroot/www/admin/application/admin/view/public/menu.html";i:1662533153;s:62:"/www/wwwroot/www/admin/application/admin/view/public/head.html";i:1638604914;s:64:"/www/wwwroot/www/admin/application/admin/view/public/footer.html";i:1638604914;}*/ ?>
<!DOCTYPE html>
<html lang="zh">
<head>
<meta charset="utf-8">
    ...
    layui.use(['table','element','form','layer','laydate'], function(){
        ...
        table.render({
            ...
            ,cols: [[
                ...
                {field:'id', title:'CID', fixed: 'left', unresize: true, sort: true,width:100},
                {field:'name', title:'地区名称'},
                {field:'count', title:'类下数量', sort: true},
        ...
        table.on('toolbar(table)', function(obj){
            ...
            case 'add':
                layer.open({
                    ...
                    area: ['893px', '600px'],
                    content: "<?php echo url('addressoperation'); ?>"+"?operation=add"
                });          
                break;
        };
  });
    ...
    if(obj.event === 'del'){
      layer.confirm('确认删除数据？', function(index){
        ...
        layer.open({
          ...
          maxmin: true, //开启最大化最小化按钮
          area: ['900px', '600px'],
          content: "<?php echo url('addressoperation'); ?>"+"?operation=edit&id="+obj.data.id
        }); 
    }
  });
});
