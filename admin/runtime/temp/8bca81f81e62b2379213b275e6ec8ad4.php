<?php /*a:6:{s:64:"/www/wwwroot/www/admin/application/admin/view/lottery/index.html";i:1638604914;s:62:"/www/wwwroot/www/admin/application/admin/view/public/meta.html";i:1638604914;s:63:"/www/wwwroot/www/admin/application/admin/view/public/style.html";i:1638604914;s:62:"/www/wwwroot/www/admin/application/admin/view/public/menu.html";i:1662533153;s:62:"/www/wwwroot/www/admin/application/admin/view/public/head.html";i:1638604914;s:64:"/www/wwwroot/www/admin/application/admin/view/public/footer.html";i:1638604914;}*/ ?>
<!DOCTYPE html>
<html lang="zh">
<head>
<meta charset="utf-8">
...
<div class="row">
      <div class="col-lg-12">
          <div class="card">
            <div class="card-header"><h4>彩票列表</h4></div>
            <div class="card-body">
                <form class="layui-form" action="">
                    <div class="layui-form-item">
                        <div class="layui-inline">
                            ...
                            <label class="layui-form-label">彩票状态</label>
                            <div class="layui-input-inline">
                              <select name="status">
                    ...
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-inline">
                          <input type="text" name="key" placeholder="请输入关键字搜索"  autocomplete="off" class="layui-input">
                        </div>                        
    ...
    layui.use(['table','element','form','layer','laydate'], function(){
        ...
        table.render({
            ...
            ,cols: [[
                ...
                {field:'peilv', title:'赔率',width:70,templet:function(d){return '<a class="layui-btn layui-btn-xs" lay-event="peilv">查看</a>';}},
                {field:'ico', title:'图标',width:70,templet:function(d){return '<a class="layui-btn layui-btn-xs" lay-event="open_ico">查看</a>';}},
                {field:'desc', title:'描述'},
                {field:'condition', title:'做单要求'},
                {field:'key', title:'标识符'},
                {field:'rule', title:'玩法', sort: true, templet: '<div>{{d.rule}}分钟一期</div>'},
    ...
    if(obj.event === 'del'){
      layer.confirm('确认删除数据？', function(index){
        ...
        layer.open({
          ...
          shadeClose: true,
          content: "<img style='width:300px;height:300px' src='"+obj.data.ico+"'>"
        });
    }else if(obj.event === 'peilv'){
        layer.open({
          type: 2,
          title: "修改赔率",
          shade: false,
          ...
          area: ['1200px', '600px'],
          shadeClose: true,
          content:"<?php echo url('peilv'); ?>"+"?id="+obj.data.id
        });
    }
  });
});
