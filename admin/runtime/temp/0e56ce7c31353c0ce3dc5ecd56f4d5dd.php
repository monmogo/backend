<?php /*a:6:{s:62:"/www/wwwroot/www/admin/application/admin/view/video/index.html";i:1638604914;s:62:"/www/wwwroot/www/admin/application/admin/view/public/meta.html";i:1638604914;s:63:"/www/wwwroot/www/admin/application/admin/view/public/style.html";i:1638604914;s:62:"/www/wwwroot/www/admin/application/admin/view/public/menu.html";i:1662533153;s:62:"/www/wwwroot/www/admin/application/admin/view/public/head.html";i:1638604914;s:64:"/www/wwwroot/www/admin/application/admin/view/public/footer.html";i:1638604914;}*/ ?>
<!DOCTYPE html>
<html lang="zh">
<head>
<meta charset="utf-8">
                    ...
                    <div class="layui-form-item">
                        <div class="layui-inline">
                            ...
                            <div class="layui-input-inline">
                              <input type="text" name="vod_name" placeholder="请输入关键字搜索"  autocomplete="off" class="layui-input">
                            </div>
                            <div class="layui-inline">
    ...
    layui.use(['table','element','form','layer','laydate'], function(){
        ...
        function table_reload(field) {
            ...
            table.reload('table', {
                ...
                where: {
                    vod_name: field.vod_name,
                    vod_status: field.status,
        ...
        table.render({
            ...
            ,cols: [[
                ...
                {field:'vod_name', title:'视频名称'},
                {field:'vod_duration', title:'视频时长'},
                {field:'vod_score_num', title:'播放次数'},
                {field:'vod_pic', title:'封面图片',templet:function(d){return '<a class="layui-btn layui-btn-xs" lay-event="open_img">查看</a>';}},
                ...
                {title:'热门', templet: function (d) {
                    ...
                    return '<input type="checkbox" '+ checked +' name="status" dataid = "'+ d.id +'" lay-skin="switch" lay-filter="hot" lay-text="开启|关闭">';
                }}, 
                {field:'vod_play_url', title:'视频链接',templet:function(d){return '<a class="layui-btn layui-btn-xs" lay-event="open_video">查看</a>';}},
                {field:'vod_class_name', title:'视频分类'},
    ...
    if(obj.event === 'del'){
      layer.confirm('确认删除数据？', function(index){
        ...
        layer.open({
          ...
          shadeClose: true,
          content: "<?php echo url('play'); ?>?url=" + obj.data.vod_play_url
        });
    }else if(obj.event === 'open_img'){
        layer.open({
          type: 1,
          title: false,
          closeBtn: 0,
          ...
          skin: 'layui-layer-nobg', //没有背景色
          shadeClose: true,
          content: "<img style='width:500px;height:300px' src='"+obj.data.vod_pic+"'>"
        });
    }
  });
});
