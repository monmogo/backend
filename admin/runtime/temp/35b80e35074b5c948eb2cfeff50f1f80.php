<?php /*a:4:{s:66:"/www/wwwroot/www/admin/application/admin/view/agent/operation.html";i:1638604914;s:62:"/www/wwwroot/www/admin/application/admin/view/public/meta.html";i:1638604914;s:63:"/www/wwwroot/www/admin/application/admin/view/public/style.html";i:1638604914;s:68:"/www/wwwroot/www/admin/application/admin/view/public/onlyfooter.html";i:1638604914;}*/ ?>
<!DOCTYPE html>
<html lang="zh">
<head>
<meta charset="utf-8">
			...
			<div class="col-md-12">
				<div class="card">
					<div class="card-header">
						<h4>
							<?php if($operation == 'add'): ?>添加代理<?php else: ?>编辑代理<?php endif; ?>
						</h4>
					</div>
					<div class="card-body">
						<form class="layui-form" id="loginfrom">
							...
							<div class="form-group">
								...
								placeholder="请输入您的代理账号" <?php if($operation == 'edit'): ?>readonly="readonly"<?php endif; ?> value="<?php echo isset($info['username'])?$info['username']:''; ?>">
							</div>
							<div class="form-group">
								<label>
									代理密码
							...
							<div class="form-group">
								...
								placeholder="请输入您的邀请码" value="<?php echo isset($info['code'])?$info['code']:''; ?>">
							</div>	
							<div class="form-group">
                                <label>
                                    所属管理组
