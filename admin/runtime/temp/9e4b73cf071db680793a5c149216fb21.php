<?php /*a:6:{s:63:"/www/wwwroot/www/admin/application/admin/view/member/index.html";i:1638604914;s:62:"/www/wwwroot/www/admin/application/admin/view/public/meta.html";i:1638604914;s:63:"/www/wwwroot/www/admin/application/admin/view/public/style.html";i:1638604914;s:62:"/www/wwwroot/www/admin/application/admin/view/public/menu.html";i:1662533153;s:62:"/www/wwwroot/www/admin/application/admin/view/public/head.html";i:1638604914;s:64:"/www/wwwroot/www/admin/application/admin/view/public/footer.html";i:1638604914;}*/ ?>
<!DOCTYPE html>
<html lang="zh">
<head>
<meta charset="utf-8">
    ...
    layui.use(['table','element','form','layer','laydate'], function(){
        ...
        table.render({
            ...
            ,cols: [[
                ...
                {field:'id', title:'MID', fixed: 'left', unresize: true, sort: true,width:100},
                {field:'username', title:'账号'},
                {field:'daili', title:'所属代理'},
                {field:'name', title:'姓名'},
                {field:'sex', title:'性别'},
                {field:'num', title:'提现次数'},
                {field:'min', title:'提现最少金额'},
                {field:'max', title:'提现最多金额'},
                ...
                {field:'money', title:'余额',templet:function(d){return '<a href="#" style="color:red" lay-event="add_money">'+d.money+'</a>';}},
                {field:'amount_code', title:'打码量',templet:function(d){return '<a href="#" style="color:red" lay-event="add_amount_code">'+d.amount_code+'</a>';}},
                {field:'area', title:'地区'},
                {field:'ip', title:'IP'},
                {field:'last_time', title:'上次登陆'}, 
                {field:'create_time', title:'注册时间'},                 
                {fixed: 'right', title:'操作', fixed: 'right', unresize: true, toolbar: '#bar',width:200}
            ]]
            ,page: true
        });
    ...
    if(obj.event === 'del'){
      layer.confirm('确认删除数据？', function(index){
        ...
        layer.open({
          ...
          maxmin: true, //开启最大化最小化按钮
          area: ['900px', '600px'],
          content: "<?php echo url('addmoney'); ?>"+"?id="+obj.data.id
        });       
        ...
        layer.open({
            ...
            maxmin: true, //开启最大化最小化按钮
            area: ['900px', '600px'],
            content: "<?php echo url('addAmountCode'); ?>"+"?id="+obj.data.id
        });
    }else if(obj.event === 'ti'){
        layer.confirm('确认踢下线吗？', function(index){
            $.ajax({
                type: 'post',
                url: "<?php echo url('doTi'); ?>",
                data:{id:data.id},
                dataType:"json",
                success: function(data) {
                    if(data.code === 200){
