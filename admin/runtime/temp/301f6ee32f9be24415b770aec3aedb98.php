<?php /*a:4:{s:67:"/www/wwwroot/www/admin/application/admin/view/notice/operation.html";i:1638604914;s:62:"/www/wwwroot/www/admin/application/admin/view/public/meta.html";i:1638604914;s:63:"/www/wwwroot/www/admin/application/admin/view/public/style.html";i:1638604914;s:68:"/www/wwwroot/www/admin/application/admin/view/public/onlyfooter.html";i:1638604914;}*/ ?>
<!DOCTYPE html>
<html lang="zh">
<head>
<meta charset="utf-8">
			...
			<div class="col-md-12">
				<div class="card">
					<div class="card-header">
						<h4>
							<?php if($operation == 'add'): ?>添加公告<?php else: ?>编辑公告<?php endif; ?>
						</h4>
					</div>
					<div class="card-body">
						<form class="layui-form" id="loginfrom">
							...
							<div class="form-group">
								...
								<textarea class="form-control" id="text" name="text" rows="6" placeholder="请输入您的公告内容"><?php if($operation == 'edit'): ?><?php echo isset($info['text'])?$info['text']:''; ?><?php endif; ?></textarea>	
							</div>
							<div class="form-group">
